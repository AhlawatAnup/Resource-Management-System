# MAyA is a Multi-user Allocation system for compute Automation

![Node.js](https://img.shields.io/badge/Node.js-v22%2B-brightgreen?style=flat-square&logo=node.js)
...
MAyA is a Multi-user Allocation system for compute Automation. It is essentially a resource management system designed for high-performance computing (HPC) machines.
...
Try the project live at the [U.I.E.T AI Data Centre](https://aicentre.puchd.ac.in/).

## Documentation

Read the [MAYA Documentation](https://aicentre.gitbook.io/maya-docs) for detailed information about the usage, setup, deployment, and usage.
...
## Deploy MAYA at Your Own Premises

Deploy MAYA at your own premises. Read the detailed deployment documentation at [MAYA Deployment Documentation](https://aicentre.gitbook.io/maya-docs/deployement/deploy-maya-at-your-premises).
