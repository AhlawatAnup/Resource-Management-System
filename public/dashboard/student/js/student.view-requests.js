...
function displayAllRequests(requests) {
    ...
    const requestsHTML = sortedRequests.map(request => {
        ...
        return `
        <div class="request-item detailed" data-status="${getRequestStatus(request)}" style="position:relative; border:1px solid #ddd; border-radius:12px; padding:16px; margin-bottom:16px; background:#fff; box-shadow:0 2px 6px rgba(0,0,0,0.05);">
            ...
            <!-- Footer (Bottom-Right Request ID & Date) -->
