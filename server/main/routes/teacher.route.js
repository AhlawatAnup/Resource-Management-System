...
const { teacher_dashboard_data } = require('../controllers/teacher.controller.js');
...
router.get('/view-requests', isTeacher, (req, res) => {
  res.sendFile(path.join(publicPath, 'dashboard', 'teacher', 'view-requests.html'));
});
router.get('/about-us', isTeacher, (req, res) => {
  res.sendFile(path.join(publicPath, 'dashboard', 'teacher', 'about-us.html'));
});
router.get('/allotments', isTeacher, (req, res) => {
  res.sendFile(path.join(publicPath, 'dashboard', 'teacher', 'allotments.html'));
});
